...
ECS::Entity SaltnPepper::createSaltnPepper(json stats, json position)
{
	...
	auto hit_anim = AnimationData("saltnpepper_hit", spritePath("enemies/saltnpepper/hit/hit"), 9, 1, true, false);
	anims.addAnimation(AnimationType::HIT, std::make_shared<AnimationData>(hit_anim));

	auto attack1_anim = AnimationData("saltnpepper_attack1", spritePath("enemies/saltnpepper/attack1/attack1"), 15, 1, true, false);
	anims.addAnimation(AnimationType::ATTACK1, std::make_shared<AnimationData>(attack1_anim));

	auto attack2_anim = AnimationData("saltnpepper_attack2", spritePath("enemies/saltnpepper/attack2/attack2"), 15, 1, true, false);
	anims.addAnimation(AnimationType::ATTACK2, std::make_shared<AnimationData>(attack2_anim));

	auto defeat_anim = AnimationData("saltnpepper_defeat", spritePath("enemies/saltnpepper/defeat/defeat"), 10, 1, true, false, vec2(-0.15f, 0.06f));
	anims.addAnimation(AnimationType::DEFEAT, std::make_shared<AnimationData>(defeat_anim));
